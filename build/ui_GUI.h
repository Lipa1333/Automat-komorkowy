...
public:
    ...
    {
        GUIClass->setWindowTitle(QApplication::translate("GUIClass", "Cellular Automata", 0));
        StartButton->setText(QApplication::translate("GUIClass", "Start", 0));
        StepButton->setText(QApplication::translate("GUIClass", "Step", 0));
        StopButton->setText(QApplication::translate("GUIClass", "Stop", 0));
        LoadButton->setText(QApplication::translate("GUIClass", "Load", 0));
        SaveButton->setText(QApplication::translate("GUIClass", "Save", 0));
        StepSaveButton->setText(QApplication::translate("GUIClass", "Save step?", 0));
        XCoordinateText->setPlainText(QApplication::translate("GUIClass", "0", 0));
        XCoordinateLabel->setText(QApplication::translate("GUIClass", "X coordinate", 0));
        YCoordinateLabel->setText(QApplication::translate("GUIClass", "Y coordinate", 0));
        YCoordinateText->setPlainText(QApplication::translate("GUIClass", "0", 0));
        NewButton->setText(QApplication::translate("GUIClass", "New", 0));
        ShowButton->setText(QApplication::translate("GUIClass", "Show", 0));
        EditButton->setText(QApplication::translate("GUIClass", "Edit", 0));
        LoadScriptButton->setText(QApplication::translate("GUIClass", "Load Script", 0));
        ScriptLabel->setText(QApplication::translate("GUIClass", "Script Status: Not loaded", 0));
        SaveScriptButton->setText(QApplication::translate("GUIClass", "Execute", 0));
    } // retranslateUi
