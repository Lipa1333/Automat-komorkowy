...
public:
    ...
    {
        EditorWindow->setWindowTitle(QApplication::translate("EditorWindow", "Edit", Q_NULLPTR));
        SaveButton->setText(QApplication::translate("EditorWindow", "Save Data", Q_NULLPTR));
        CloseButton->setText(QApplication::translate("EditorWindow", "Close", Q_NULLPTR));
        xPosLabel->setText(QApplication::translate("EditorWindow", "X position:", Q_NULLPTR));
        VarValLabel->setText(QApplication::translate("EditorWindow", "Value:", Q_NULLPTR));
        VarNumLabel->setText(QApplication::translate("EditorWindow", "Variable #:", Q_NULLPTR));
        yPosLabel->setText(QApplication::translate("EditorWindow", "Y position:", Q_NULLPTR));
        xText->setPlainText(QApplication::translate("EditorWindow", "0", Q_NULLPTR));
        yText->setPlainText(QApplication::translate("EditorWindow", "0", Q_NULLPTR));
        variableText->setPlainText(QApplication::translate("EditorWindow", "0", Q_NULLPTR));
        valueText->setPlainText(QApplication::translate("EditorWindow", "0", Q_NULLPTR));
    } // retranslateUi
